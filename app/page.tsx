...
const features = [
  ...
  },
  {
    ...
    description: "Students can prioritize skills, location, job type, and fresher-friendly openings.",
    icon: Filter
  },
  {
    title: "Save jobs",
    ...
    <div>
        ...
        <div className="relative mx-auto grid min-h-[calc(100vh-4rem)] max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/72">
              JobSwipe reduces job-search screen time by replacing long job boards with personalized, one-card-at-a-time discovery for students and freshers.
            </p>
            ...
            <div className="rounded-[2rem] border border-white/12 bg-white/8 p-3 shadow-glow backdrop-blur">
              <div className="rounded-[1.5rem] bg-paper p-4 text-ink">
                ...
                <p className="mt-6 text-sm leading-6 text-ink/62">
                  Build polished UI flows for a campus hiring analytics product. Ideal for students with React project experience.
                </p>
      ...
      <section id="features" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-4 text-3xl font-black tracking-tight text-ink sm:text-4xl">A focused portal for students, recruiters, and admins.</h2>
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <article className="dark-panel rounded-3xl p-6 md:col-span-2 lg:col-span-1">
            ...
            <p className="mt-2 text-sm leading-6 text-white/68">
              Seeded data, demo logins, Prisma models, and a polished main swipe flow make the project easy to explain in interviews.
            </p>
          </article>
        </div>
      </section>
