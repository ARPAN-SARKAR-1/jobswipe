...
import com.jobswipe.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
  ...
  public CorsConfigurationSource corsConfigurationSource() {
    ...
    configuration.setAllowedOrigins(List.of(appProperties.getFrontendUrl(), "http://localhost:3000", "http://127.0.0.1:3000"));
