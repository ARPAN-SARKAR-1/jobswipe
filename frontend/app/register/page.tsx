  ...
  return (
    <section className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[0.9fr_1fr] lg:px-8">
      <div>
        ...
        <h1 className="mt-4 text-4xl font-black tracking-tight text-ink sm:text-5xl">Create a job seeker or recruiter account.</h1>
        <p className="mt-4 text-base leading-7 text-ink/62">
          Job seekers can start swiping immediately. Recruiters get a dashboard for posting openings and managing applicants.
        </p>
